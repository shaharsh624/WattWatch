...
import 'package:wattwatch_v1/pages/questions2.dart';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text("Question 1", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.0),),
                  ],
                ),
              ),
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Question 1?", style: TextStyle(fontSize: 24.0, color: Color(0xff7a7a7a)),),
                        Padding(
